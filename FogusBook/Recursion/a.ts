...
function tcLength(arr: any[], n: number = 0) {
    if (arr.length === 0) {
        return n;
    }
    else {
...
// tcLength([], 6) => 6
//------------------------------------------------------------------------------------------------------------------------------
function cycle(times, arr: any[]): any[] {
    if (times === 0) {
        return [];
    }
    else {
...
function nexts(graph: [string, string][], node: string) {
    if (graph.length === 0) { //Stop When
        return [];
    }
